...
class TxaLanguage extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'vi': {
      ...
      // Google Play Games (GPGS) Cloud Conflict & Sync
      'gpgs_conflict_title': 'XUNG ĐỘT TIẾN TRÌNH ĐÁM MÂY',
      'gpgs_conflict_subtitle': 'Dữ liệu trên Google Play Games khác với tiến trình trên máy. Bạn muốn sử dụng bản lưu nào?',
      'gpgs_conflict_local_title': 'TIẾN TRÌNH TRÊN MÁY (HIỆN TẠI)',
      'gpgs_conflict_cloud_title': 'TIẾN TRÌNH GOOGLE PLAY GAMES',
      'gpgs_level_label': 'Màn mở khóa',
      'gpgs_stars_label': 'Tổng số sao',
      'gpgs_score_label': 'Kỷ lục điểm số',
      'gpgs_synced_time_label': 'Thời gian lưu',
      'gpgs_btn_keep_local': 'GIỮ TIẾN TRÌNH MÁY (Lưu lên GPGS)',
      'gpgs_btn_use_cloud': 'LẤY TỪ GPGS (Ghi đè cục bộ)',
      'gpgs_overwrite_success': 'Đã ghi đè tiến trình từ GPGS thành công!',
      'gpgs_upload_success': 'Đã đồng bộ tiến trình máy lên GPGS!',
      'gpgs_section_title': 'Google Play Games',
      'gpgs_status_connected': 'Đã kết nối',
      'gpgs_status_disconnected': 'Chưa kết nối',
      'gpgs_btn_login': 'Đăng nhập Google Play Games',
      'gpgs_btn_sync': 'Đồng bộ Đám mây (Kiểm tra xung đột)',
      'gpgs_btn_achievements': 'Bảng Thành Tựu',
      'gpgs_syncing': 'Đang kiểm tra & đồng bộ...',
      'gpgs_login_failed': 'Không thể kết nối với Google Play Games',

      // In-Game Achievement Banner & Titles
      'ach_unlocked_banner_title': 'MỞ KHÓA THÀNH TỰU!',
      'ach_sector_1_title': 'Khởi Đầu Lượng Tử',
      'ach_sector_1_desc': 'Hoàn thành Sector đầu tiên của Chiến Dịch',
      'ach_sector_10_title': 'Thám Hiểm Sector 10',
      'ach_sector_10_desc': 'Chinh phục thành công Sector 10',
      'ach_sector_25_title': 'Bậc Thầy Sector 25',
      'ach_sector_25_desc': 'Vượt qua Sector 25 đầy thử thách',
      'ach_sector_50_title': 'Nửa Chặng Đường',
      'ach_sector_50_desc': 'Đạt mốc Sector 50 Chiến Dịch',
      'ach_sector_75_title': 'Chuyên Gia Lượng Tử',
      'ach_sector_75_desc': 'Chinh phục thành công Sector 75',
      'ach_sector_100_title': 'Huyền Thoại Zero Grid',
      'ach_sector_100_desc': 'Phá đảo toàn bộ 100 Sector Chiến Dịch',
      'ach_stars_10_title': 'Thu Thập Tinh Tú',
      'ach_stars_10_desc': 'Tích lũy 10 ngôi sao Chiến Dịch',
      'ach_stars_50_title': 'Bộ Sưu Tập Tinh Vân',
      'ach_stars_50_desc': 'Tích lũy 50 ngôi sao Chiến Dịch',
      'ach_stars_100_title': 'Bầu Trời Ánh Sáng',
      'ach_stars_100_desc': 'Tích lũy 100 ngôi sao Chiến Dịch',
      'ach_stars_200_title': 'Dải Ngân Hà Lượng Tử',
      'ach_stars_200_desc': 'Tích lũy 200 ngôi sao Chiến Dịch',
      'ach_stars_300_title': 'Đỉnh Cao Hoàn Hảo 300★',
      'ach_stars_300_desc': 'Sở hữu trọn vẹn 300 sao Chiến Dịch',
      'ach_perfectionist_title': 'Kẻ Cầu Toàn',
      'ach_perfectionist_desc': 'Chiến thắng màn chơi với tối đa 3 sao',
      'ach_streak_3_title': 'Bất Bại Sơ Cấp (3 Chuỗi)',
      'ach_streak_3_desc': 'Thắng liên tiếp 3 ván chơi',
      'ach_streak_5_title': 'Chuỗi Thắng Lửa (5 Chuỗi)',
      'ach_streak_5_desc': 'Thắng liên tiếp 5 ván chơi',
      'ach_streak_10_title': 'Bất Khả Chiến Bại (10 Chuỗi)',
      'ach_streak_10_desc': 'Thắng liên tiếp 10 ván chơi',
      'ach_wins_10_title': 'Chiến Binh 10 Trận',
      'ach_wins_10_desc': 'Tích lũy 10 trận thắng',
      'ach_wins_50_title': 'Cao Thủ 50 Trận',
      'ach_wins_50_desc': 'Tích lũy 50 trận thắng',
      'ach_wins_100_title': 'Đại Kiện Tướng 100 Trận',
      'ach_wins_100_desc': 'Tích lũy 100 trận thắng',
      'ach_combo_3_title': 'Combo Bộ Ba',
      'ach_combo_3_desc': 'Kích hoạt combo 3 số 0 liên tiếp',
      'ach_combo_5_title': 'Bậc Thầy Combo x5',
      'ach_combo_5_desc': 'Kích hoạt chuỗi combo hệ số x5',
      'ach_combo_8_title': 'Cuồng Nộ Lượng Tử x8',
      'ach_combo_8_desc': 'Đạt chuỗi combo đỉnh cao x8',
      'ach_speed_demon_title': 'Bóng Ma Tốc Độ',
      'ach_speed_demon_desc': 'Phá giải bàn cờ trong thời gian kỷ lục',
      'ach_no_hint_title': 'Trí Tuệ Thuần Khiết',
      'ach_no_hint_desc': 'Hoàn thành màn khó không dùng gợi ý',
      'ach_endless_100_title': 'Sống Sót Vô Tận (100đ)',
      'ach_endless_100_desc': 'Đạt 100 điểm chế độ Bất Tận',
      'ach_endless_500_title': 'Bất Tận Bền Bỉ (500đ)',
      'ach_endless_500_desc': 'Đạt 500 điểm chế độ Bất Tận',
      'ach_endless_1000_title': 'Chúa Tể Bất Tận (1000đ)',
      'ach_endless_1000_desc': 'Đạt 1000 điểm chế độ Bất Tận',
      'ach_daily_1_title': 'Thử Thách Ngày 1',
      'ach_daily_1_desc': 'Hoàn thành thử thách ngày đầu tiên',
      'ach_daily_3_title': 'Chăm Chỉ 3 Ngày',
      'ach_daily_3_desc': 'Hoàn thành thử thách ngày 3 chặng',
      'ach_daily_7_title': 'Tuần Lễ Hoàn Hảo',
      'ach_daily_7_desc': 'Hoàn thành toàn bộ thử thách ngày trong tuần',
      'ach_lb_submit_title': 'Ghi Tên Bảng Vàng',
      'ach_lb_submit_desc': 'Gửi điểm thành công lên Bảng Xếp Hạng',
      'ach_lb_top100_title': 'Top 100 Thế Giới',
      'ach_lb_top100_desc': 'Lọt vào top 100 cao thủ',
      'ach_lb_top50_title': 'Top 50 Thế Giới',
      'ach_lb_top50_desc': 'Lọt vào top 50 cao thủ',
      'ach_lb_top10_title': 'Top 10 Tinh Anh',
      'ach_lb_top10_desc': 'Ghi danh trong top 10 bảng xếp hạng',
      'ach_lb_top1_title': 'Đệ Nhất Lượng Tử (Top 1)',
      'ach_lb_top1_desc': 'Chiếm lĩnh vị trí Top 1 Thế Giới',
      'ach_lb_daily_podium_title': 'Bục Vinh Quang Ngày',
      'ach_lb_daily_podium_desc': 'Lọt top đầu trong thử thách ngày',
      'ach_lb_score_50k_title': 'Đại Phú Điểm Số (50K)',
      'ach_lb_score_50k_desc': 'Tích lũy tổng điểm đạt 50,000 điểm',
    },
    'en': {
      // Main Menu & General
      'app_title': 'ZERO GRID',
      ...
      // Google Play Games (GPGS) Cloud Conflict & Sync
      'gpgs_conflict_title': 'CLOUD SAVE CONFLICT',
      'gpgs_conflict_subtitle': 'Google Play Games cloud data differs from current device data. Which save would you like to keep?',
      'gpgs_conflict_local_title': 'CURRENT / LOCAL SAVE',
      'gpgs_conflict_cloud_title': 'GOOGLE PLAY GAMES CLOUD SAVE',
      'gpgs_level_label': 'Unlocked Sector',
      'gpgs_stars_label': 'Total Stars',
      'gpgs_score_label': 'High Score',
      'gpgs_synced_time_label': 'Saved At',
      'gpgs_btn_keep_local': 'KEEP LOCAL (Upload to GPGS)',
      'gpgs_btn_use_cloud': 'USE GPGS (Overwrite Local)',
      'gpgs_overwrite_success': 'Successfully overwritten with GPGS progress!',
      'gpgs_upload_success': 'Current progress synced to GPGS cloud!',
      'gpgs_section_title': 'Google Play Games',
      'gpgs_status_connected': 'Connected',
      'gpgs_status_disconnected': 'Not Connected',
      'gpgs_btn_login': 'Sign In with Google Play Games',
      'gpgs_btn_sync': 'Sync Cloud Save (Check Conflict)',
      'gpgs_btn_achievements': 'Achievements',
      'gpgs_syncing': 'Checking & syncing...',
      'gpgs_login_failed': 'Failed to connect to Google Play Games',

      // In-Game Achievement Banner & Titles
      'ach_unlocked_banner_title': 'ACHIEVEMENT UNLOCKED!',
      'ach_sector_1_title': 'Quantum Origin',
      'ach_sector_1_desc': 'Clear your first Campaign Sector',
      'ach_sector_10_title': 'Sector 10 Pioneer',
      'ach_sector_10_desc': 'Conquer Sector 10',
      'ach_sector_25_title': 'Sector 25 Master',
      'ach_sector_25_desc': 'Overcome challenging Sector 25',
      'ach_sector_50_title': 'Halfway Point',
      'ach_sector_50_desc': 'Reach Campaign Sector 50',
      'ach_sector_75_title': 'Quantum Expert',
      'ach_sector_75_desc': 'Conquer Sector 75',
      'ach_sector_100_title': 'Zero Grid Legend',
      'ach_sector_100_desc': 'Clear all 100 Campaign Sectors',
      'ach_stars_10_title': 'Star Gatherer',
      'ach_stars_10_desc': 'Accumulate 10 Campaign Stars',
      'ach_stars_50_title': 'Nebula Collector',
      'ach_stars_50_desc': 'Accumulate 50 Campaign Stars',
      'ach_stars_100_title': 'Celestial Vault',
      'ach_stars_100_desc': 'Accumulate 100 Campaign Stars',
      'ach_stars_200_title': 'Quantum Galaxy',
      'ach_stars_200_desc': 'Accumulate 200 Campaign Stars',
      'ach_stars_300_title': 'Apex Perfection 300★',
      'ach_stars_300_desc': 'Possess full 300 Campaign Stars',
      'ach_perfectionist_title': 'The Perfectionist',
      'ach_perfectionist_desc': 'Win a sector with maximum 3 stars',
      'ach_streak_3_title': 'Novice Streak (3 Wins)',
      'ach_streak_3_desc': 'Win 3 matches in a row',
      'ach_streak_5_title': 'Flame Streak (5 Wins)',
      'ach_streak_5_desc': 'Win 5 matches in a row',
      'ach_streak_10_title': 'Unstoppable (10 Wins)',
      'ach_streak_10_desc': 'Win 10 matches in a row',
      'ach_wins_10_title': '10-Win Combatant',
      'ach_wins_10_desc': 'Accumulate 10 match wins',
      'ach_wins_50_title': '50-Win Veteran',
      'ach_wins_50_desc': 'Accumulate 50 match wins',
      'ach_wins_100_title': '100-Win Grandmaster',
      'ach_wins_100_desc': 'Accumulate 100 match wins',
      'ach_combo_3_title': 'Triple Combo',
      'ach_combo_3_desc': 'Trigger 3 consecutive zero combos',
      'ach_combo_5_title': 'Combo Master x5',
      'ach_combo_5_desc': 'Trigger x5 combo chain multiplier',
      'ach_combo_8_title': 'Quantum Fury x8',
      'ach_combo_8_desc': 'Achieve pinnacle x8 combo streak',
      'ach_speed_demon_title': 'Speed Demon',
      'ach_speed_demon_desc': 'Clear puzzle in record time',
      'ach_no_hint_title': 'Pure Mind',
      'ach_no_hint_desc': 'Complete a hard stage without any hints',
      'ach_endless_100_title': 'Endless Survivor (100pts)',
      'ach_endless_100_desc': 'Score 100 pts in Endless Mode',
      'ach_endless_500_title': 'Endless Endurance (500pts)',
      'ach_endless_500_desc': 'Score 500 pts in Endless Mode',
      'ach_endless_1000_title': 'Endless Lord (1000pts)',
      'ach_endless_1000_desc': 'Score 1000 pts in Endless Mode',
      'ach_daily_1_title': 'Daily Challenge 1',
      'ach_daily_1_desc': 'Complete your first daily challenge',
      'ach_daily_3_title': '3-Day Dedication',
      'ach_daily_3_desc': 'Complete 3 daily challenge stages',
      'ach_daily_7_title': 'Weekly Perfection',
      'ach_daily_7_desc': 'Complete daily challenges for a full week',
      'ach_lb_submit_title': 'Hall of Fame Entry',
      'ach_lb_submit_desc': 'Successfully submit score to Leaderboard',
      'ach_lb_top100_title': 'Global Top 100',
      'ach_lb_top100_desc': 'Rank among top 100 players',
      'ach_lb_top50_title': 'Global Top 50',
      'ach_lb_top50_desc': 'Rank among top 50 players',
      'ach_lb_top10_title': 'Top 10 Elite',
      'ach_lb_top10_desc': 'Enter top 10 on the leaderboard',
      'ach_lb_top1_title': 'Quantum Champion (Rank 1)',
      'ach_lb_top1_desc': 'Seize Rank 1 on Global Leaderboard',
      'ach_lb_daily_podium_title': 'Daily Podium',
      'ach_lb_daily_podium_desc': 'Reach podium rank in daily challenge',
      'ach_lb_score_50k_title': 'Score Magnate (50K)',
      'ach_lb_score_50k_desc': 'Accumulate 50,000 total points',
    },
  };
